...
get_type = UserType.get(username,"")

if get_pass == password and get_type == "Admin":
    print("VELKOMIN Admin")
    while svarid != "exit":
        valmyndGUI()
        ...
        if svarid == "1":
            ...
            if CrudSvar == "c" or CrudSvar =="C":
                ...
                Place_id_crud = input("Name of place to be deleted: ")
...
elif get_pass == password and get_type == "User":
    print("VELKOMIN User")
elif get_pass == "":
    print("EKKI TIL")
else:
